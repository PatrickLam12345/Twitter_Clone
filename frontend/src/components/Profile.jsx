...
export default function Profile() {
    ...
    if (username && userInfo) {
      try {
        const response = await axios.get(
          "https://twitterclone2024.onrender.com/api/user/getUserProfileAndIsFollowingByUsername",
          {
            headers: {
  ...
  const getFollowers = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getFollowerCount",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getFollowing = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getFollowingCount",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getTweets = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getTweetsByUser",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getReplies = async () => {
    ...
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getRepliesByUser",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getRetweets = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getRetweetsByUser",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getLikes = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getLikesByUser",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const getMentions = async () => {
    try {
      const response = await axios.get(
        "https://twitterclone2024.onrender.com/api/user/getMentionsByUser",
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
          },
  ...
  const editProfile = async () => {
    ...
    try {
      const response = await axios.patch(
        "https://twitterclone2024.onrender.com/api/user/editUserProfile",
        formData,
        {
          headers: {
            authorization: window.localStorage.getItem("token"),
